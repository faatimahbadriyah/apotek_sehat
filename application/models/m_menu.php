...
class M_menu extends CI_Model{
	...
	// }
	function hot_promo(){
		$hsl=$this->db->query("SELECT menu_id,menu_nama,menu_deskripsi,LEFT(menu_harga_lama,2) AS harga_lama,LEFT(menu_harga_baru,2) AS harga_baru,menu_harga_lama,menu_harga_baru,menu_likes,menu_kategori_id,menu_kategori_nama,menu_gambar FROM tbl_menu  ORDER BY (menu_harga_lama-menu_harga_baru) DESC");
		return $hsl;
	}
	function obat_luar(){
