		...
		<div class="container">
			...
			<div class="jumbotron">
				<div class="panel panel-default">
					<div class="panel-heading" style="font-size: 14pt; background-color: #f4511e; color:white;">Konfirmasi Pesanan</div>
						<div class="panel-body">
							<?php echo $this->session->flashdata('msg');?>
							<form action="<?php echo base_url().'mobile/konfirmasi/simpan_konfirmasi'?>" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="nama">No. Invoice</label>
									<input class="form-control" type="text" name="no_invoice" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="kontak">Bank</label>
									<input class="form-control" type="text" name="bank" required>
								</div>
								<div class="form-group">
									<label for="kontak">Nominal</label>			
								...
								<button type="submit" class="btn btn-lg btn-primary " style="background-color: #f4511e; color:white; border: 0px;">Submit</button>
							</form>
						</div>				
					</div>	
				</div>					
