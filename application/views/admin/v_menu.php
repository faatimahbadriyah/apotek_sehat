			...
			<div id="content">
				<section>
					<div class="section-header">
							<h2><span class="fa fa-medkit"></span> Data Obat</h2>
					</div>
				...
				<section class="style-default-bright" style="margin-top:0px;">
					<p><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal_add_pengguna"><span class="fa fa-plus"></span> Tambah Obat</a></p>
